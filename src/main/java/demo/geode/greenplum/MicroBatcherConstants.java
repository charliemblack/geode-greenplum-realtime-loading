...
public class MicroBatcherConstants {
    public static final String CONNECTION_POOL_PROPERTIES = "connectionPoolProperties";
    public static final String PIPE_FILE_LOCATION = "pipeFileLocation";
